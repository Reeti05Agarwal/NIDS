...
public class PS6 {
    ...
    public static void parsePacket(byte[] packet) {
        ...
        String srcMac = getMacAddress(packet, 6);  
        String destMac = getMacAddress(packet, 0);  
    ...
    private static void parseIPv4Header(byte[] packet) {
        ...
        String srcIP = getIpAddress(packet, 26);  
        String destIP = getIpAddress(packet, 30);  
        ...
        switch (protocol) {
            case 1:
                System.out.println("  Protocol: ICMP (1)");
                parseICMPHeader(packet);
                break;
            case 2:
                System.out.println("  Protocol: IGMP (2)");
                break;
            case 6:
                System.out.println("  Protocol: TCP (6)");
            ...
            case 17:
                ...
                break;
            case 50:
                System.out.println("  Protocol: ESP (50) - IPSec");
                break;
            case 51:
                System.out.println("  Protocol: AH (51) - IPSec");
                break;
            case 47:
                System.out.println("  Protocol: GRE (47)");
                break;
            case 132:
                System.out.println("  Protocol: SCTP (132)");
                break;
            default:
                System.out.println("  Protocol: Unknown (" + protocol + ")");
        }
    ...
    private static void parseICMPHeader(byte[] packet) {
        int type = packet[34] & 0xFF;
        int code = packet[35] & 0xFF;
        System.out.println("\nICMP Header:");
