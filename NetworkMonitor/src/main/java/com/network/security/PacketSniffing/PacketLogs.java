...
public class PacketLogs {
    ...
    private static Map<String, Object> parsePacket(byte[] packet) {
        ...
        System.out.println("[DEBUG] EtherType in Integer: " + Integer.toHexString(ethType));  
        System.out.println("[DEBUG] EtherType in Hex: " + Integer.toHexString(ethType));
        System.out.println("[DEBUG] EtherType in Decimal: " + ethType); 
        int offset = 0;  
